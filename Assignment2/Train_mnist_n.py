...
for i in range(0,n):
    ...
    autoencoder.save('autoencoder_increment'+str(i)+'.h5')
    classifier.save('classifier_increment' + str(i) + '.h5')
...
for i in range(0,n):
    ...
    filepath_autoencoder = "weights_autoencoder_increment.best.hdf5"
    ...
    autoencoder = load_model('autoencoder_increment'+str(i)+'.h5')
...
for k in range(0,epochs):
    ...
    for i in range(0,number_of_batches):
        ...
        autoencoder = load_model('autoencoder_increment' + str(min_error_index) + '.h5')
        ...
        autoencoder.save('autoencoder_increment' + str(min_error_index) + '.h5')
        classifier.save('classifier_increment' + str(min_error_index) + '.h5')
